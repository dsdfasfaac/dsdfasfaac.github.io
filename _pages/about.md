...
<div class="entry entry--with-logo">
  ...
  <div class="entry__logo"><img src="{{ '/images/organizations/air.png' | relative_url }}" alt="AIR, Tsinghua University logo" loading="lazy"></div>
...
<div class="entry entry--with-logo">
  ...
  <div class="entry__logo"><img src="{{ '/images/organizations/eit.png' | relative_url }}" alt="Eastern Institute of Technology, Ningbo logo" loading="lazy"></div>
...
<div class="entry entry--compact entry--with-logo">
  ...
  <div class="entry__logo entry__logo--ustc"><img src="{{ '/images/organizations/ustc-wordmark.png' | relative_url }}" alt="University of Science and Technology of China logo" loading="lazy"></div>
  <p>M.Eng., Electronic and Information Engineering</p>
</div>

<div class="entry entry--compact entry--with-logo">
  <div class="entry__heading"><h3>Hunan University</h3><span>2021–2025</span></div>
  <div class="entry__logo entry__logo--hnu"><img src="{{ '/images/organizations/hnu-wordmark.png' | relative_url }}" alt="Hunan University logo" loading="lazy"></div>
